...
[![NuGet](https://img.shields.io/nuget/v/IgrisModz.MauiIcons.Material.Round.svg)](https://www.nuget.org/packages/IgrisModz.MauiIcons.Material.Round/)
![.NET Version](https://img.shields.io/badge/.NET-10.0-purple.svg)

This library provides **Material Round** support for **.NET MAUI** (.NET 10). It allows you to use icons as fonts, offering full control over size, color, and animations with high performance.
...
```bash
dotnet add package IgrisModz.MauiIcons.Material.Round
```
...
```xml
<mi:MaterialRoundIcon Icon="Heart" 
                         TextColor="Red" 
                         FontSize="40" 
                         Animation="Pulse" 
...
```xml
<Label Text="{mi:MaterialRound Icon=Home, Size=60, Color=DarkBlue}" />
<Image Source="{mi:MaterialRound Icon=Image, Size=50}" />
```

### Platform-Specific Icons

```xml
<mi:MaterialRoundIcon Icon="{mi:MaterialRoundPlatform WinUI=Image, Android=Home}" />
```
