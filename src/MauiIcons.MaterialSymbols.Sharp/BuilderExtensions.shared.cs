...
/// <summary>
/// Extension methods for configuring Material Symbols Sharp icons in a .NET MAUI application.
/// </summary>
public static class BuilderExtensions
{
    private const string FontFileName = "material-symbols-sharp.ttf";
    ...
    public static MauiAppBuilder UseMaterialSymbolsSharp(this MauiAppBuilder builder)
    {
