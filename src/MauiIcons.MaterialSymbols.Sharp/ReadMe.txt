*******************************************************************************************
.NET MAUI Icons - Material Symbols Sharp (Variable Font)
*******************************************************************************************
...
2. RECOMMENDED CONTROLS:
   - Use the direct control: <mi:MaterialSymbolsSharpIcon />
...
<mi:MaterialSymbolsSharpIcon Icon="Search" 
                                Weight="700" 
                                Fill="True" /> 

Markup Extension (Limited to default style):
<Label Text="{mi:MaterialSymbolsSharp Icon=Favorite}" />
