...
This library provides **Material Symbols Sharp** support for **.NET MAUI** (.NET 10). It utilizes **Variable Font** technology to offer highly customizable icons.
...
* **Full Support:** Use the direct control `<mi:MaterialSymbolsSharpIcon />`.
...
```csharp
builder.UseMaterialSymbolsSharp();
```
...
```xml
<mi:MaterialSymbolsSharpIcon Icon="Settings" 
                                TextColor="Blue" 
                                FontSize="40" 
                                Weight="700" 
                                Fill="True" />
...
```xml
<ContentView>
    <mi:MaterialSymbolsSharpIcon Icon="Home" Weight="100" />
</ContentView>
```
