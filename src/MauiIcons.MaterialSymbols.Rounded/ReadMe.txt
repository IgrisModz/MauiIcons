*******************************************************************************************
.NET MAUI Icons - Material Symbols Rounded (Variable Font)
*******************************************************************************************
...
2. RECOMMENDED CONTROLS:
   - Use the direct control: <mi:MaterialSymbolsRoundedIcon />
...
<Label Text="{mi:MaterialSymbolsRounded Icon=Favorite}" />
