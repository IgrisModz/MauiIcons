...
[![NuGet](https://img.shields.io/nuget/v/IgrisModz.MauiIcons.FontAwesome.Brands.svg)](https://www.nuget.org/packages/IgrisModz.MauiIcons.FontAwesome.Brands/)
![.NET Version](https://img.shields.io/badge/.NET-10.0-purple.svg)

This library provides **FontAwesome Brands** support for **.NET MAUI** (.NET 10). It allows you to use icons as fonts, offering full control over size, color, and animations with high performance.
...
```bash
dotnet add package IgrisModz.MauiIcons.FontAwesome.Brands
```
...
```xml
<mi:FontAwesomeBrandsIcon Icon="Facebook" 
                          TextColor="Blue" 
                          FontSize="40" 
                          Animation="Shake" 
...
<Image Source="{mi:FontAwesomeBrands Icon=Github, Size=50}" />
```

### Platform-Specific Icons

```xml
<mi:FontAwesomeBrandsIcon Icon="{mi:FontAwesomeBrandsPlatform WinUI=Youtube, Android=Discord}" />
```
