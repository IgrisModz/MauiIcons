...
[![NuGet](https://img.shields.io/nuget/v/IgrisModz.MauiIcons.Material.Regular.svg)](https://www.nuget.org/packages/IgrisModz.MauiIcons.Material.Regular/)
![.NET Version](https://img.shields.io/badge/.NET-10.0-purple.svg)

This library provides **Material Regular** support for **.NET MAUI** (.NET 10). It allows you to use icons as fonts, offering full control over size, color, and animations with high performance.
...
```bash
dotnet add package IgrisModz.MauiIcons.Material.Regular
```
...
```xml
<mi:MaterialRegularIcon Icon="Heart" 
                         TextColor="Red" 
                         FontSize="40" 
                         Animation="Pulse" 
...
```xml
<Label Text="{mi:MaterialRegular Icon=Home, Size=60, Color=DarkBlue}" />
<Image Source="{mi:MaterialRegular Icon=Image, Size=50}" />
```

### Platform-Specific Icons

```xml
<mi:MaterialRegularIcon Icon="{mi:MaterialRegularPlatform WinUI=Image, Android=Home}" />
```
