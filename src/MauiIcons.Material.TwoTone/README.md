...
[![NuGet](https://img.shields.io/nuget/v/IgrisModz.MauiIcons.Material.TwoTone.svg)](https://www.nuget.org/packages/IgrisModz.MauiIcons.Material.TwoTone/)
![.NET Version](https://img.shields.io/badge/.NET-10.0-purple.svg)

This library provides **Material TwoTone** support for **.NET MAUI** (.NET 10). It allows you to use icons as fonts, offering full control over size, color, and animations with high performance.
...
```bash
dotnet add package IgrisModz.MauiIcons.Material.TwoTone
```
...
```xml
<mi:MaterialTwoToneIcon Icon="Heart" 
                         TextColor="Red" 
                         FontSize="40" 
                         Animation="Pulse" 
...
```xml
<Label Text="{mi:MaterialTwoTone Icon=Home, Size=60, Color=DarkBlue}" />
<Image Source="{mi:MaterialTwoTone Icon=Image, Size=50}" />
```

### Platform-Specific Icons

```xml
<mi:MaterialTwoToneIcon Icon="{mi:MaterialTwoTonePlatform WinUI=Image, Android=Home}" />
```
